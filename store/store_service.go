...
func SaveUrlMapping(shortUrl string, originalUrl string, userId string) {
	err := storeService.Set(ctx, shortUrl, originalUrl, CacheDuration).Err()
	if err != nil {
...
func RetrieveInitialUrl(shortUrl string) string {
	result, err := storeService.Get(ctx, shortUrl).Result()
	if err != nil {
